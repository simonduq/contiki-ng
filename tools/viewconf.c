...
#if TSCH_CONF_DEFAULT_TIMING
##### "TSCH_CONF_DEFAULT_TIMING": ______________ == TSCH_CONF_DEFAULT_TIMING
#else
##### "TSCH_CONF_DEFAULT_TIMING": ______________ -> TSCH_DEFAULT_TIMING
#endif
